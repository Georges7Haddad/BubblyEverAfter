    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("voltage", models.PositiveIntegerField(blank=True, help_text="in Volts", null=True)),
                ("wattage", models.PositiveIntegerField(blank=True, help_text="in Watts", null=True)),
            ],
