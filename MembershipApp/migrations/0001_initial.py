# Generated by Django 3.0.2 on 2020-04-05 23:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(
                    choices=[('RV', 'RV'), ('Travel Trailer', 'Travel Trailer'), ('Shiftpod', 'Shiftpod'),
                             ('Kodiak Tent', 'Kodiak Tent'), ('No Bake Tent', 'No Bake Tent'),
                             ('Siesta2 Tent', 'Siesta2 Tent'), ('Siesta4 Tent', 'Siesta4 Tent'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender_identity',
                 models.CharField(blank=True, default=None, help_text='To ensure camp diversity', max_length=127,
                                  null=True)),
                ('ethnic_identity',
                 models.CharField(blank=True, default=None, help_text='To ensure camp diversity', max_length=127,
                                  null=True)),
                ...
                ('years_attending_burning_man',
                 models.CharField(blank=True, default=None, help_text='Please separate them with commas',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number',
                 models.CharField(blank=True, default=None, help_text='ID number found on the back of your ticket',
                                  max_length=127, null=True)),
                ...
                ('holder', models.ForeignKey(help_text='Name of the current vehicle pass holder',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    choices=[('Pre Sale', 'Pre Sale'), ('Main Sale', 'Main Sale'), ('DGS', 'DGS'),
                             ('OMG Sale', 'OMG Sale'), ('Low Income Approved', 'Low Income Approved'), ('STEP', 'STEP'),
                             ('Third Party (Friend/Seller)', 'Third Party (Friend/Seller)')], max_length=127)),
                ('number',
                 models.CharField(blank=True, default=None, help_text='ID number found on the back of your ticket',
                                  max_length=127, null=True)),
                ('price', models.PositiveIntegerField(blank=True, default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1984),
                ...
                ('type', models.CharField(
                    choices=[('Burner Air', 'Burner Air'), ('Burner Bus', 'Burner Bus'), ('Carpool', 'Carpool'), (
                    'Own Transportation (will need vehicle pass)', 'Own Transportation (will need vehicle pass)'),
                             ('Other', 'Other')], max_length=127)),
                ('camp_dues', models.PositiveIntegerField(default=0,
                                                          help_text='Payment that each camping member should pay to join bubbly camp')),
                ('camp_dues_paid', models.PositiveIntegerField(default=0)),
                ('strike_deposit', models.PositiveIntegerField(default=0,
                ...
                ('meal_plan', models.BooleanField(default=False,
                                                  help_text='Payment that each camping member should pay to join the meal plan')),
                ...
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                (
                'ticket', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='MembershipApp.Ticket')),
                ('vehicle_pass',
                 models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            name='members',
            field=models.ManyToManyField(through='MembershipApp.UserAccommodationRelation',
                                         to=settings.AUTH_USER_MODEL),
        ),
    ]
